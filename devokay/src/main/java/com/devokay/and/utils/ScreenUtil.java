...
public final class ScreenUtil {
  ...
  public static int getScreenWidth() {
    WindowManager wm = (WindowManager) U.getApp().getSystemService(Context.WINDOW_SERVICE);
  ...
  public static boolean isLandscape() {
    return U.getApp().getResources().getConfiguration().orientation
  ...
  public static boolean isScreenLock() {
    KeyguardManager km =
      (KeyguardManager) U.getApp().getSystemService(Context.KEYGUARD_SERVICE);
  ...
  public static boolean isTablet() {
    return (U.getApp().getResources().getConfiguration().screenLayout
